...
ScreenManagerSandboxMain::ScreenManagerSandboxMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
ScreenManagerSandboxMain::~ScreenManagerSandboxMain()
{
...
void ScreenManagerSandboxMain::CreateWindowSizeDependentResources() 
{
...
void ScreenManagerSandboxMain::StopRenderLoop()
{
	m_renderLoopWorker->Cancel();
}

// Updates the application state once per frame.
void ScreenManagerSandboxMain::Update() 
{
	ProcessInput();
...
void ScreenManagerSandboxMain::ProcessInput()
{
...
bool ScreenManagerSandboxMain::Render() 
{
...
void ScreenManagerSandboxMain::OnDeviceLost()
{
...
void ScreenManagerSandboxMain::OnDeviceRestored()
{
